...
return ( <header className="sticky top-0 z-50"> <nav className="backdrop-blur-md bg-gray-900/95 border-b border-gray-800 text-white px-4 md:px-8 py-3 shadow-lg"> <div className="mx-auto max-w-6xl flex items-center justify-between">
{/* Left: Brand / Menu */} <div className="flex items-center gap-3">
{/* Brand */} <div className="flex items-center gap-2"> <div className="text-lg font-semibold tracking-wide">Penguin</div>
{otherUser && ( <div className="text-xs text-gray-400">
{(() => {
...
```
                if (isRecentTyping) {
                  ...
                  return `${otherUser.name} last seen ${new Date(
                    otherUser.lastSeen
          ...
          {otherUser && (
            <span className="text-xs text-gray-400">
              {otherUser.isOnline
                ...
                : otherUser.lastSeen
                ? `${otherUser.name} last seen ${new Date(
                    otherUser.lastSeen
                  ).toLocaleTimeString([], {
                    hour: "2-digit",
                    minute: "2-digit",
